...
public class User extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtutype, 0, 241, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(106, 106, 106)
  ...
  /*      
        ...
        try {
            ...
            String sql =("insert into user values ('"+name+"','"+username+"','"+password+"','"+usertype+"')");
...
try {
    PreparedStatement pst = con.prepareStatement("INSERT INTO user (name, username, password, utype) VALUES (?, ?, ?, ?)");
    pst.setString(1, name);
    pst.setString(2, username);
    pst.setString(3, password);
    ...
    // Additional code here (e.g., success message, error handling)
